...
// 插入数据库
func (sqlite3DB *Sqlite3DB) Insert(ModelData model.MysqlModel) (sql.Result, error) {
...
// 更新数据，返回操作条数
func (sqlite3DB *Sqlite3DB) Update(ModelData model.MysqlModel) (sql.Result, error) {
	if sqlite3DB.model == nil {

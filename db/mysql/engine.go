...
//   - 需要手动添加 _ "github.com/go-sql-driver/mysql" 包
...
//   - 字段名最终会使用 MySQL 的反引号引用: `column` ASC/DESC
//   - 多次调用会覆盖之前的排序设置
...
//   - MySQL 使用 LIMIT pageSize OFFSET offset 实现分页

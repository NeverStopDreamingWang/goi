...
func init() {
	...
	// embed.FS 静态文件
	example.Server.Router.StaticFilePatternsFS("index1.html", "测试静态FS文件", template.IndexHtml)

	// embed.FS 静态目录
	example.Server.Router.StaticDirPatternsFS("static1", "测试静态FS目录", template.Html)
